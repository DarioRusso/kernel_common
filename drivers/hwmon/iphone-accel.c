...
//static DEVICE_ATTR(acceleration, S_IRUGO, iphone_accel_show, NULL);
...
/* 
static int iphone_accel_input_open(struct input_dev *inp)
{
	printk("DarioDebug: iphone_accel_input_open called\n");
	return 0;
}

static void iphone_accel_input_close(struct input_dev *inp)
{
	printk("DarioDebug: iphone_accel_input_close called\n");
}
*/
                            ...
                            const struct i2c_device_id *device_id)
{
	...
	printk( "iphone_accel: Dario: adding input device...\n");
...
//	accel_info->input_dev->open= iphone_accel_input_open;
//	accel_info->input_dev->close= iphone_accel_input_close;
	...
	printk( "iphone_accel: Dario: input_register_polled_device...\n");
